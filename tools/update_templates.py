...
update_file(str(TEMPLATES_DIR / 'base.html'), r'<style>.*?</style>', base_style)
...
update_file(str(TEMPLATES_DIR / 'index.html'), r'<style>.*?</style>', index_style)
...
with open(str(TEMPLATES_DIR / 'index.html'), 'w', encoding='utf-8') as f:
    f.write(js_content)
